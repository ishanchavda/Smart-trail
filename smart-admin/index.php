...
<head>
  ...
  <title>Welcome Smart-Trail Admin</title>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              <p>Parking Registrations</p>
            </div>
            <div class="icon">
              <i class="ion ion-model-s"></i>
            </div>
            <a href="tables.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>
			  <?php
			  $result = mysqli_query($conn,"SELECT * FROM smart_site_visitor");  
		      $num = mysqli_num_rows($result);
			  echo $num;
			  ?>
			  </h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>
			  <?php
			  $result = mysqli_query($conn,"SELECT * FROM smart_rto_employee");  
		      $num = mysqli_num_rows($result);
			  echo $num;
			  ?>
			  </h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3>
			  <?php
			  $result = mysqli_query($conn,"SELECT * FROM smart_admin_visitor");  
		      $num = mysqli_num_rows($result);
			  echo $num;
			  ?>
			  </h3>
...
$email_subject = $sub;
$email_body = "Mail From Admin of Smart-Trail '$adminname'.\n\n"."$message\n\n\n Thank You\nSmart-Trail RTO Admin";
