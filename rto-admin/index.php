...
<head>
  ...
  <title>Welcome to Smart-Trail RTO Admin</title>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3>
			  <?php
			  $result = mysqli_query($conn,"SELECT * FROM smart_penalty ");  
			  $sum =0;
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3>
			  <?php
			  $result = mysqli_query($conn,"SELECT * FROM smart_rto_admin_visitor WHERE admin_id = " . $_SESSION['rto_id']);  
		      $num = mysqli_num_rows($result);
			  echo $num;
			  ?>
			  </h3>
...
$adminid=$_SESSION['rto_id'];
$adminname=$_SESSION['rto_name'];
...
$email_subject = $sub;
$email_body = "Mail From RTO Admin of Smart-Trail '$adminname'.\n\n"."$message\n\n\n Thank You\nSmart-Trail RTO Admin";
