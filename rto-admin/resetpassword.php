...
if (isset($_POST['change'])) 
{
	...
	$sql="SELECT * FROM smart_rto_admin WHERE (ra_email = '" . $email. "' OR ra_username = '".$email. "')";
	...
	{ $error=false;
		...
		if (!$error) 
		{
			if(mysqli_query($conn, "UPDATE smart_rto_admin SET ra_password='$password' WHERE ra_id='$id'"))
			{
...
<head>
  ...
  <title>Reset Password | Smart-Trail Admin | Smart-Trail</title>
