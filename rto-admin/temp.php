...
if(isset($_POST['addemployee'])) 
{
	...
	{	/*$mno = $mobileno;
		$message =  "Now You are Employee of Smart-Trail username:$username and Password:$password link:https://smart-trail.ga";
		if(preg_match( '/^[A-Z0-9]{10}$/', $mno) && !empty($message)) {
			$ch = curl_init();
			$user="strail2018@gmail.com:smart2018";
			$receipientno="9979004778";
			$senderID="TEST SMS";
			$msgtxt= $message; 
...
<!-- Left side column. contains the logo and sidebar -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="inde.php"><i class="fa fa-dashboard"></i> Home</a></li>
