...
if (isset($_POST['login'])) {
	...
	$sql = "SELECT * FROM smart_rto_employee WHERE (email = '" . $email. "' OR username = '".$email."' )and password = '" .$password. "'";
...
<head>
  ...
  <title>Log in | RTO Employee | Smart-Trail</title>
