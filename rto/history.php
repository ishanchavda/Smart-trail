...
<head>
  ...
  <title>RTO Employee History | RTO Employee | Smart-Trail</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="history.php"><i class="fa fa-book"></i><span>History</span></a></li>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
 <?php
$sql="SELECT * FROM smart_rto_employee_visitor WHERE emp_id= ".$_SESSION['emp_id'] ." ";
